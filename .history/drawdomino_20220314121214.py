...
def drawdomino(cas,cell0,cell1):
    if cell0.x0 == cell1.x0 :
        if cell0.y0 < cell1.y0:
            cas.create_rectangle(cell0.x0 + 5, cell0.y0 + 5, cell1.x0 + 55, cell1.y0 + 55,fill="grey40")
        else:
            cas.create_rectangle(cell1.x0 + 5, cell1.y0 + 5, cell0.x0 + 55, cell0.y0 + 55, fill="grey40")
    elif cell0.x0 < cell1.x0:
        cas.create_rectangle(cell0.x0 + 5, cell0.y0 + 5, cell1.x0 + 55, cell1.y0 + 55,fill="grey40")
    else:
        as.create_rectangle(cell1.x0 + 5, cell1.y0 + 5, cell0.x0 + 55, cell0.y0 + 55, fill="grey40")
